...
export const Tick = () => {
    ...
    return(
        <svg width="23" height="18" viewBox="0 0 23 18" fill="none">
            <path className={clsx(darkMode ? `fill-white` : `fill-[#4D4D4D]`)} fillRule="evenodd" clipRule="evenodd" d="M22.8402 2.49999L22.0446 3.29548L8.85534 16.4848C7.83023 17.5099 6.16817 17.5099 5.14304 16.4848L0.953698 12.2955L0.158203 11.5L1.7492 9.909L2.54469 10.7045L6.73403 14.8939C6.88047 15.0403 7.11791 15.0403 7.26435 14.8939L20.4537 1.70449L21.2492 0.908997L22.8402 2.49999Z"/>
        </svg>
